...
export const siteConfig: SiteConfig = {
    ...
    banner: {
        ...
        src: {
            desktop: [
                "/assets/desktop-banner/my_1.webp",
                // "/assets/desktop-banner/my_2.jpg",
    ...
    links: [
        ...
        // 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
        {
            ...
            children: [
                {
                    name: "GitHub",
                    url: "https://github.com/Lilaccccc",
                    external: true,
                    icon: "fa6-brands:github",
                },
                {
                    name: "BiliBili",
                    url: "https://space.bilibili.com/37686577",
                    external: true,
                    icon: "fa6-brands:bilibili",
                },
                {
                    name: "Steam",
                    url: "https://steamcommunity.com/profiles/76561198378167603/",
                    external: true,
